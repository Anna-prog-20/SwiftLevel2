...
//    }
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        print("рисуем collectionView \(segueOnePhoto.photoUser)")
        //print("рисуем init \(segueOnePhoto.photoUser?.arrayValue)")
        //segueOnePhoto.nameOnePhoto = "\(namePhotos[indexPath.row])"
    }
